    ...
    <div className="card p-6 animate-fade-in">
      ...
      <div className="flex justify-end">
        <button
          ...
          className={`btn btn-primary ${(selectedOption === null || isSubmitting) ? 'opacity-50 cursor-not-allowed' : ''}`}
        >
          {isSubmitting ? (
            <>
